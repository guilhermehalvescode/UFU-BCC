...
INSERT INTO faculdade VALUES
 (1, 'FACOM', 120000.70, NULL, 1), -- diretor: 1
 (2, 'FAGEN', 300000.70, NULL, 2), -- diretor: 5
 (3, 'FAMAT', 100000.70, NULL, 3); -- diretor: 3
...
/* PROFESSORES VINCULADOS A FACULDADE */
UPDATE faculdade SET idpes = 1 WHERE idfacul = 1;
UPDATE faculdade SET idpes = 5 WHERE idfacul = 2;
UPDATE faculdade SET idpes = 3 WHERE idfacul = 3;
